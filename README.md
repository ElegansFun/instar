...
| `site/` | The cage, rendered from the world's live stream: glass, dishes, lamp, articulated flies walking and flying; the market; the census. Custodial accounts or your own wallet. Epoch hashes are verified against the World account by the CLI verifier, or in a desktop browser on demand. |
